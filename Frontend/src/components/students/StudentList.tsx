...
export const StudentList: React.FC<StudentListProps> = ({ onSelectStudent, onAddStudent }) => {
  ...
  useEffect(() => {
    const fetchStudents = async () => {
      try {
        const response = await axios.get('http://localhost:5000/api/students'); // Update the URL if necessary
            ...
            >
              <div className="flex justify-between items-center">
                ...
                <div className="text-right">
                  <p className="font-medium text-blue-600">{student.overallGrade ?? 'N/A'}%</p>
